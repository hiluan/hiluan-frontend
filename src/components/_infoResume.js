export const workExperience = [
  ...
  },
  {
    ...
    tasks: [
      "Consulted with clients to identify design requirements, resulting in a 95% client satisfaction rate.",
      "Developed innovative design recommendations based on budget, site constraints, and emerging trends, resulting in a 20% increase in client referrals.",
      "Produced detailed architectural plans using CAD software and manual drawing techniques, ensuring 100% accuracy and approval from both management and clients.",
      "Contributed to the successful completion of 25+ projects, ranging from €50,000 to €10 million in value, generating over €1 million for the firms over the years.",
    ],
    contactPerson: "",
    website: null,
  },
